...
C_SRCS += \
../Core/Src/timers/tmr11.c 

OBJS += \
./Core/Src/timers/tmr11.o 

C_DEPS += \
./Core/Src/timers/tmr11.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/timers/%.o Core/Src/timers/%.su Core/Src/timers/%.cyclo: ../Core/Src/timers/%.c Core/Src/timers/subdir.mk
...
clean: clean-Core-2f-Src-2f-timers

clean-Core-2f-Src-2f-timers:
	-$(RM) ./Core/Src/timers/tmr11.cyclo ./Core/Src/timers/tmr11.d ./Core/Src/timers/tmr11.o ./Core/Src/timers/tmr11.su

.PHONY: clean-Core-2f-Src-2f-timers
